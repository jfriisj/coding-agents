...
- Update workflow status only with the correct `handoff_id`.
EOF
}
...
.github/skills/workflow-memory/SKILL.md|WF memory contract and existence-gate behavior.|skill_stub
.github/agents/01a-Roadmap.agent.md|Custom agent definition: Strategic vision holder maintaining outcome-focused product roadmap aligned with releases.|agent_stub
.github/agents/02a-Planner.agent.md|Custom agent definition: High-rigor planning assistant for upcoming feature changes.|agent_stub
.github/agents/02b-Analyst.agent.md|Custom agent definition: Research and analysis specialist for code-level investigation and determination.|agent_stub
.github/agents/02c-Architect.agent.md|Custom agent definition: Maintains architectural coherence across features and reviews technical debt accumulation.|agent_stub
.github/agents/02d-Security.agent.md|Custom agent definition: Comprehensive security audit specialist - architecture, code, dependencies, and compliance.|agent_stub
.github/agents/02e-Critic.agent.md|Custom agent definition: Constructive reviewer and program manager that stress-tests planning documents.|agent_stub
.github/agents/03a-Implementer.agent.md|Custom agent definition: Execution-focused coding agent that implements approved plans.|agent_stub
.github/agents/03c-CodeReviewer.agent.md|Custom agent definition: Reviews code quality, architecture alignment, and maintainability before QA testing.|agent_stub
.github/agents/04a-QA.agent.md|Custom agent definition: Dedicated QA specialist verifying test coverage and execution before implementation approval.|agent_stub
.github/agents/04b-UAT.agent.md|Custom agent definition: Product Owner conducting UAT to verify implementation delivers stated business value.|agent_stub
.github/agents/05a-DevOps.agent.md|Custom agent definition: DevOps specialist responsible for packaging, versioning, deployment readiness, and release execution.|agent_stub
.github/agents/05b-Retrospective.agent.md|Custom agent definition: Captures lessons learned, architectural decisions, and patterns after implementation completes.|agent_stub
.github/agents/05c-ProcessImprovement.agent.md|Custom agent definition: Analyzes retrospectives and systematically improves agent workflows.|agent_stub
EOF
